...
grep -q 'intentional legacy-compatible MD5 verification path' "${SCRIPT_PATH}" || fail 'installer is missing its intentional SHA-256-unavailable MD5 fallback wording'
